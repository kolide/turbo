var tests_unit = (function (exports, intern) {
    ...
    class Visit {
        constructor(delegate, location, restorationIdentifier, options = {}) {
            ...
            this.response = response;
            this.isSamePage = (getRequestURL(location) === getRequestURL(this.view.lastRenderedLocation) &&
    ...
    class DeprecatedAdapterSupportTest extends DOMTestCase {
        constructor() {
            super(...arguments);
            this.locations = [];
            this.originalAdapter = navigator.adapter;
        }
        async setup() {
            registerAdapter(this);
        }
        async teardown() {
            registerAdapter(this.originalAdapter);
        }
        async "test visit proposal location includes deprecated absoluteURL property"() {
            navigator.proposeVisit(new URL(window.location.toString()));
        ...
        async "test visit start location includes deprecated absoluteURL property"() {
            navigator.startVisit(window.location.toString(), "123");
            this.assert.equal(this.locations.length, 1);
            const [location] = this.locations;
            this.assert.equal(location.toString(), location.absoluteURL);
        }
    ...
    class StreamElementTests extends DOMTestCase {
        ...
        async "test action=append"() {
            ...
            await nextAnimationFrame();
            this.assert.equal((_c = this.find("#hello")) === null || _c === void 0 ? void 0 : _c.textContent, "Hello Turbo Streams and more");
        ...
        async "test action=append with children ID already present in target"() {
            ...
            this.append(element);
            await nextAnimationFrame();
            this.assert.equal((_b = this.find("#hello")) === null || _b === void 0 ? void 0 : _b.textContent, 'Hello Turbo First tail1 ');
            this.assert.isNull(element.parentElement);
            this.append(element2);
            await nextAnimationFrame();
            this.assert.equal((_c = this.find("#hello")) === null || _c === void 0 ? void 0 : _c.textContent, 'Hello Turbo  tail1 New First Second tail2 ');
        }
        async "test action=prepend"() {
            ...
            this.append(element2);
            await nextAnimationFrame();
            this.assert.equal((_c = this.find("#hello")) === null || _c === void 0 ? void 0 : _c.textContent, "and more Streams Hello Turbo");
            this.assert.isNull(element.parentElement);
        }
        async "test action=prepend with children ID already present in target"() {
            ...
            this.append(element);
            await nextAnimationFrame();
            this.assert.equal((_b = this.find("#hello")) === null || _b === void 0 ? void 0 : _b.textContent, 'First tail1 Hello Turbo');
            this.assert.isNull(element.parentElement);
            this.append(element2);
            await nextAnimationFrame();
            this.assert.equal((_c = this.find("#hello")) === null || _c === void 0 ? void 0 : _c.textContent, 'New First Second tail2  tail1 Hello Turbo');
        }
        ...
        async "test action=after"() {
            ...
            this.append(element);
            await nextAnimationFrame();
            this.assert.equal((_c = (_b = this.find("#hello")) === null || _b === void 0 ? void 0 : _b.nextSibling) === null || _c === void 0 ? void 0 : _c.textContent, "After Turbo");
            this.assert.ok(this.find("div#hello"));
        ...
        async "test action=before"() {
            ...
            this.append(element);
            await nextAnimationFrame();
            this.assert.equal((_c = (_b = this.find("#hello")) === null || _b === void 0 ? void 0 : _b.previousSibling) === null || _c === void 0 ? void 0 : _c.textContent, "Before Turbo");
            this.assert.ok(this.find("div#hello"));
    ...
    exports.DeprecatedAdapterSupportTest = DeprecatedAdapterSupportTest;
