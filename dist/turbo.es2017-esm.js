...
class Session {
    ...
    persistScrollPosition() {
        this.sessionStorage.set(SCROLL_POSITION, Object.assign({ location: Location.currentLocation.toString() }, this.scrollObserver.position));
    }
    restorePersistedScrollPosition() {
        const persistedPosition = this.sessionStorage.get(SCROLL_POSITION);
