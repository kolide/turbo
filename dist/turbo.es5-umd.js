...
(function (global, factory) {
    ...
    ***************************************************************************** */
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            return [4, this.allowRequestToBeIntercepted(fetchOptions)];
                        case 1:
                            _c.sent();
                            _c.label = 2;
                        case 2:
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            renderInterception = new Promise(function (resolve) { return _this.resolveInterceptionPromise = resolve; });
                ...
                this.render(function () { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                this.cacheSnapshot();
                                if (!this.view.renderPromise) return [3, 2];
                            ...
                            case 3:
                                ...
                                this.complete();
                                return [3, 6];
                            case 4: return [4, this.view.renderError(PageSnapshot.fromHTMLString(responseHTML_1))];
                            case 5:
                                _a.sent();
                                this.adapter.visitRendered(this);
                                this.fail();
    ...
    var BrowserAdapter = (function () {
        ...
        BrowserAdapter.prototype.showVisitProgressBarAfterDelay = function () {
            this.visitProgressBarTimeout = window.setTimeout(this.showProgressBar, this.session.progressBarDelay);
        };
        BrowserAdapter.prototype.hideVisitProgressBar = function () {
        ...
        BrowserAdapter.prototype.showFormProgressBarAfterDelay = function () {
            if (this.formProgressBarTimeout == null) {
                this.formProgressBarTimeout = window.setTimeout(this.showProgressBar, this.session.progressBarDelay);
            }
        };
        BrowserAdapter.prototype.hideFormProgressBar = function () {
            this.progressBar.hide();
            if (this.formProgressBarTimeout != null) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            responseHTML = _a.sent();
                            if (!responseHTML) return [3, 6];
                            snapshot = PageSnapshot.fromHTMLString(responseHTML);
                            if (!fetchResponse.serverError) return [3, 3];
    ...
    var Session = (function () {
        ...
        Session.prototype.historyPoppedToLocationWithRestorationIdentifier = function (location, restorationIdentifier) {
            if (this.enabled) {
        ...
        Session.prototype.followedLinkToLocation = function (link, location) {
            ...
            this.convertLinkWithMethodClickToFormSubmission(link) || this.visit(location.href, { action: action });
        };
        ...
        Session.prototype.allowsVisitingLocationWithAction = function (location, action) {
        ...
        Session.prototype.allowsImmediateRender = function (_a, resume) {
        ...
        Session.prototype.notifyApplicationAfterVisitingLocation = function (location, action) {
            return dispatch("turbo:visit", { detail: { url: location.href, action: action } });
        };
        Session.prototype.notifyApplicationBeforeCachingSnapshot = function () {
            return dispatch("turbo:before-cache");
        };
        Session.prototype.notifyApplicationBeforeRender = function (newBody, resume) {
            return dispatch("turbo:before-render", { detail: { newBody: newBody, resume: resume }, cancelable: true });
        };
    ...
    var FrameController = (function () {
        ...
        FrameController.prototype.loadSourceURL = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!(!this.settingSourceURL && this.enabled && this.isActive && (this.reloadable || this.sourceURL != this.currentURL))) return [3, 4];
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 3:
                            ...
                            if (!this.view.renderPromise) return [3, 5];
                            return [4, this.view.renderPromise];
                        case 4:
                            _b.sent();
                            _b.label = 5;
                        case 5: return [4, this.view.render(renderer)];
                        case 6:
                            _b.sent();
        ...
        FrameController.prototype.allowsImmediateRender = function (snapshot, resume) {
            return true;
        };
