    ...
    ***************************************************************************** */
    ...
    var PageObserver = (function () {
        function PageObserver(delegate) {
            ...
            this.beforePageUnloaded = function () {
                _this.delegate.beforePageUnloaded();
            };
            this.delegate = delegate;
        }
    ...
    var ScrollObserver = (function () {
        ...
        Object.defineProperty(ScrollObserver.prototype, "position", {
            get: function () {
    ...
    var SCROLL_POSITION = "turbo-scroll-position";
    var VIEW_INVALIDATED = "turbo-view-invalidated";
    var Session = (function () {
        ...
        Session.prototype.persistScrollPosition = function () {
            this.sessionStorage.set(SCROLL_POSITION, __assign({ location: Location.currentLocation.toString() }, this.scrollObserver.position));
        };
        Session.prototype.restorePersistedScrollPosition = function () {
            var persistedPosition = this.sessionStorage.get(SCROLL_POSITION);
            var viewInvalidated = this.sessionStorage.get(VIEW_INVALIDATED);
            if ((persistedPosition === null || persistedPosition === void 0 ? void 0 : persistedPosition.location) == Location.currentLocation.toString() && !viewInvalidated) {
        ...
        Session.prototype.beforePageUnloaded = function () {
