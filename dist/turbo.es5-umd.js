...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var History = (function () {
        function History(delegate) {
            ...
            this.onPopState = function (event) {
                if (_this.shouldHandlePopState()) {
                    var restorationIdentifier = _this.restorationIdentifierForPopState(event);
                    if (!restorationIdentifier)
                        return;
                    _this.restorationIdentifier = restorationIdentifier;
                    _this.delegate.historyPoppedToLocationWithRestorationIdentifier(Location.currentLocation, restorationIdentifier);
                }
            };
        ...
        History.prototype.restorationIdentifierForPopState = function (event) {
            if (event.state) {
        ...
        History.prototype.poppedToInitialEntry = function (event) {
