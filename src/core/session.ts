...
export class Session implements FormSubmitObserverDelegate, HistoryDelegate, LinkClickObserverDelegate, NavigatorDelegate, PageObserverDelegate, PageViewDelegate {
  ...
  viewWillRenderSnapshot({ element }: PageSnapshot, isPreview: boolean, intercept: Intercept) {
    this.notifyApplicationBeforeRender(element, intercept)
  }
  ...
  notifyApplicationBeforeRender(newBody: HTMLBodyElement, intercept: Intercept) {
    return dispatch("turbo:before-render", { detail: { newBody, intercept } })
  }
